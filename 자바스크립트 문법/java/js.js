...
// 2. 프로젝트 규모가 커질수록 유질보수 비용 증가, 안정성 저하
...
// TypeScript 마이크로소프트가 개발하고 유지하고 있는 오픈소스 프로그램밍 언어
// 자바스크립트에 타입을 부여한 언어 -> 자바스크립트 상위 버전

// 자바스크립트 대소문자 구분 O 소문자 a , A이 다른값
let A = '문자열';
let B = 12345;
let C = A + B
let D = 20 - '10';
...
// result에 num값이 복사되고 , num++는 그 다움값 부터 num에 증가
...
// 소문자 > 대문자
console.log("a" < "A");
console.log("Hello" < "Hi") // 앞 값이 동일하면 뒤에 값을 본다
...
// double2 함수내에서는 double1 함수의 변수를 사용 할 수 있지만,
// double1 함수내에서는 double2 함수를 사용할 수 없다.
let e = 1;
